...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Error al iniciar sesión. Comprueba tus credenciales e intenta de nuevo.");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <Card className="w-full max-w-md">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-menuOrange hover:underline">
        ...
        <CardFooter className="flex flex-col">
          <div className="text-sm text-gray-500 text-center mt-2">
            ...
            <Link to="/register" className="text-menuOrange hover:underline">
              Regístrate
            </Link>
          </div>
        </CardFooter>
